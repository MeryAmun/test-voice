  ...
  return (
    ...
    <div className="text-center pb-10 h-fit text-white md:pr-[5rem] md:pb-[5.5rem] mb-10 md:mb-0">
      <div className="w-[100%]">
        ...
        {toggle && (
          <div className="notify-btn flex items-center m-1">
            <button
              onClick={() =>
                setToggle((prev) => {
                  return !prev;
            ...
            <button
              className="hover:bg-opacity-25 ml-1 transition-all duration-300 cursor-pointer btn px-2 py-1 bg-opacity-20 bg-black rounded-md block text-center text-lg font-semibold w-3/4 md:w-full mx-auto"
            >
            <Link to='/grid'>
              Dashboard
            </Link>
